...
export class AbadgeClient {
  ...
  async accessSecret(params: {
    ...
    return this.request("POST", "/credentials/access", params);
  }
  ...
  async createGrant(params: {
    ...
    await this.request("POST", "/grants", params);
  }
  ...
  async createSession(params: {
    ...
    return this.request("POST", "/sessions", params);
  }
  ...
  async createConnector(params: {
    ...
    await this.request("POST", "/connectors", params);
  }
}
