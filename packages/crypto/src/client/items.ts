 ...
 */
export function serializeItemPayload(payload: Record<string, unknown>): Uint8Array {
 ...
 */
export function deserializeItemPayload(bytes: Uint8Array): Record<string, unknown> {
